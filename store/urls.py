...
urlpatterns = [
    ...
    path('plants/add-to-cart/<int:plant_id>/', views.add_plant_to_cart_view, name='add_plant_to_cart'),
    ...
    path('update-plant-cart/<int:plant_cart_id>/', views.update_plant_cart_view, name='update_plant_cart'),
    path('remove-plant-cart/<int:plant_cart_id>/', views.remove_plant_cart_view, name='remove_plant_cart'),
    ...
    path('plants/', views.customer_plants_view, name='plants'),
    ...
    path('staff/plants/', views.staff_plants_view, name='staff_plants'),
    path('staff/add-plant/', views.add_plant_view, name='add_plant'),
    path('staff/edit-plant/<int:plant_id>/', views.edit_plant_view, name='edit_plant'),
    path('staff/delete-plant/<int:plant_id>/', views.delete_plant_view, name='delete_plant'),
    ...
    path('store-admin/edit-plant/<int:plant_id>/', views.admin_edit_plant_view, name='admin_edit_plant'),
    path('store-admin/delete-plant/<int:plant_id>/', views.admin_delete_plant_view, name='admin_delete_plant'),
    path('store-admin/plant/<int:plant_id>/media/', views.admin_plant_media_view, name='admin_plant_media'),
    path('store-admin/plant/media/delete/<int:media_id>/', views.admin_delete_plant_media_view, name='admin_delete_plant_media'),
    path('store-admin/plant/media/<int:media_id>/edit/', views.admin_edit_plant_media_view, name='admin_edit_plant_media'),
    ...
    path('store-admin/accessories/ajax/', views.admin_accessories_ajax_view, name='admin_accessories_ajax'),
